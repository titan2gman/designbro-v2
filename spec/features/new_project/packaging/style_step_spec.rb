...
RSpec.feature 'Client can complete style step for packaging project', js: true do
  context 'authenticated user' do
    scenario 'chooses styles' do
      product = create(:product, key: 'logo')
      project = create(:project, state: :waiting_for_style_details, product: product)
  ...
  context 'not authenticated user' do
    scenario 'chooses styles' do
      product = create(:product, key: 'logo')
      project_without_company = create(:project_without_company, state: :waiting_for_style_details, product: product)
